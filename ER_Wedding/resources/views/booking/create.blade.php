    ...
    <form action="{{ route('wedding.store') }}" method="POST">
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <input type="number" class="box" name="guest_count" required placeholder="Guest Count">
            </div>
            <div class="form-group">
                <label for="estimated_budget">Estimated Budget</label>
                <input type="number" class="box" name="estimated_budget" required placeholder="Estimated Budget">
            </div>
        </div>
